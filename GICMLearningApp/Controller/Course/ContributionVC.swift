...
class ContributionVC: UIViewController, UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout  {
    ...
    var arrSections = ["New Idea","Develop concept","Feedback","Own business"]
    var arrarModuleImage = [#imageLiteral(resourceName: "NewIdea"),#imageLiteral(resourceName: "DevelopmentConcept"),#imageLiteral(resourceName: "Feedback"),#imageLiteral(resourceName: "OwnBussiness")]
...
//    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        nextVC.strTitle = arrSections[indexPath.row]
        nextVC.strContributionType = arrSections[indexPath.row]
